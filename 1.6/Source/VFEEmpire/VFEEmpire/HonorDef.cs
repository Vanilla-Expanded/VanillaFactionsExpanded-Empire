...
public class Honor : IExposable, ILoadReferenceable
{
    ...
    public virtual Pawn ExamplePawn =>
     ...
     ?? PawnsFinder.AllMapsCaravansAndTravellingTransporters_Alive_Colonists.FirstOrDefault(CanAssignTo)
     ?? PawnsFinder.AllCaravansAndTravellingTransporters_AliveOrDead.FirstOrDefault(CanAssignTo);
