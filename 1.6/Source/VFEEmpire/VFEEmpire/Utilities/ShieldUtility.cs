...
public static class ShieldUtility
{
    ...
    private static readonly AccessTools.FieldRef<CompProjectileInterceptor, int> startedChargingTick =
        AccessTools.FieldRefAccess<CompProjectileInterceptor, int>("startedChargingTick");
    ...
    public static int GetNextChargeTick(this CompProjectileInterceptor comp) => startedChargingTick(comp);
    public static void SetNextChargeTick(this CompProjectileInterceptor comp, int value) => startedChargingTick(comp) = value;
