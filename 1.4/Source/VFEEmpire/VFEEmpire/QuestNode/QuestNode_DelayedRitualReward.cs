    ...
    public class QuestNode_DelayedRitualReward : QuestNode
    {
        protected override void RunInt()
        {
            ...
            quest.Delay(delay, () =>
            {
                ...
                quest.DropPods(map.Parent, rewards, null, null, "[rewardLetterText]", null, new bool?(true), true, false, false, null, null, QuestPart.SignalListenMode.OngoingOnly, null, true, false, false);
