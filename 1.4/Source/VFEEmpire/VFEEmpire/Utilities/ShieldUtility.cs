...
public static class ShieldUtility
{
    ...
    private static readonly Action<CompProjectileInterceptor, IntVec3> triggerEffecter = AccessTools
       .Method(typeof(CompProjectileInterceptor), "TriggerEffecter")
       .CreateDelegate<Action<CompProjectileInterceptor, IntVec3>>();

    private static readonly Action<CompProjectileInterceptor, DamageInfo> breakShieldHitpoints = AccessTools
       .Method(typeof(CompProjectileInterceptor), "BreakShieldHitpoints")
       .CreateDelegate<Action<CompProjectileInterceptor, DamageInfo>>();
